...
class Items:
    ...
    Glider = ("Glider",
              ...
              b"\x00\xf5",
              b"\x00")
    ChargeMissile = ("Charge Missile",
              b"\x00\xf2",
              b"\x00\xf2",
              b"\x00\xf2",
              b"\x02")
    ReserveMissile = ("Reserve Missile",
              b"\x00\xf1",
              b"\x00\xf1",
              b"\x00\xf1",
              b"\x00")
...
items_unpackable: Iterable[Item] = (
    Items.Missile, Items.Super, Items.PowerBomb, Items.Morph, Items.Bombs,
    Items.HiJump, Items.Varia, Items.GravitySuit, Items.Wave, Items.SpeedBooster, Items.Spazer,
    Items.Ice, Items.Plasma, Items.Screw, Items.Grapple,
    Items.SpaceJump, Items.Energy, Items.Reserve,
    Items.Glider, Items.ChargeMissile, Items.ReserveMissile, Items.Overcharge, Items.ChargeSuper
)
